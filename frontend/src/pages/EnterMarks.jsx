...
import { BookOpen, Users, Save, AlertCircle, CheckCircle } from 'lucide-react';
    ...
    <DashboardLayout>
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="text-gray-400 mt-1">Enter internal marks for your students</p>
        </div>
          ...
          <div className="bg-gradient-to-b from-gray-900 to-gray-900/50 rounded-xl border border-gray-800 backdrop-blur-xl overflow-hidden">
            <div className="p-6 border-b border-gray-800">
              ...
              <p className="text-sm text-gray-400 mt-1">
                CIA 1, 2, 3: out of 20 | Assignment: out of 10
              </p>
            </div>
                    ...
                    <tr key={student._id} className="hover:bg-gray-800/30 transition-colors">
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-3">
                          <div className="w-10 h-10 rounded-full bg-gradient-to-br from-blue-600 to-blue-700 flex items-center justify-center text-white font-bold text-sm shadow-lg shadow-blue-500/50">
                      ...
                      <td className="px-6 py-4">
                        <input
                          ...
                          onChange={(e) =>
                            handleMarkChange(student._id, 'cia1', e.target.value)
                          }
                          className="w-20 px-3 py-2 bg-gray-800 border border-gray-700 text-white text-center rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                        />
                      </td>
                      <td className="px-6 py-4">
                        <input
                          ...
                          onChange={(e) =>
                            handleMarkChange(student._id, 'cia2', e.target.value)
                          }
                          className="w-20 px-3 py-2 bg-gray-800 border border-gray-700 text-white text-center rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                        />
                      </td>
                      <td className="px-6 py-4">
                        <input
                          ...
                          onChange={(e) =>
                            handleMarkChange(student._id, 'cia3', e.target.value)
                          }
                          className="w-20 px-3 py-2 bg-gray-800 border border-gray-700 text-white text-center rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                        />
                      </td>
                      <td className="px-6 py-4">
                        <input
                          ...
                          onChange={(e) =>
                            handleMarkChange(student._id, 'assignment', e.target.value)
                          }
                          className="w-20 px-3 py-2 bg-gray-800 border border-gray-700 text-white text-center rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                        />
                      </td>
        ...
        {selectedSubject && (
          <div className="flex justify-end">
            <button
              ...
              disabled={saving}
              className="px-8 py-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-lg font-medium hover:from-blue-700 hover:to-blue-800 disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-lg shadow-blue-500/50 flex items-center gap-2"
            >
